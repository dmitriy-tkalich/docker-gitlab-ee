...
docker run --name gitlab -d [OPTIONS] \
    creative/gitlab-ee:8.8.5 app:sanitize
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    creative/gitlab-ee:8.8.5 app:rake gitlab:backup:create
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    creative/gitlab-ee:8.8.5 app:rake gitlab:backup:restore
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    creative/gitlab-ee:8.8.5 app:rake gitlab:backup:restore BACKUP=1417624827
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    creative/gitlab-ee:8.8.5 app:rake gitlab:env:info
```
...
```bash
docker run --name gitlab -d [OPTIONS] creative/gitlab-ee:8.8.5
```
